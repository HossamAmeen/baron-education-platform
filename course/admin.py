...
class EducationGradeAdmin(admin.ModelAdmin):
    ...
    get_country.admin_order_field = 'education_stage__country' # Allows sorting by country

class SemesterAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'education_grade', 'get_education_stage', 'get_country')
    search_fields = ('name',)
    list_filter = ('education_grade__education_stage__country', 'education_grade', 'education_grade__education_stage')
    ...
    get_education_stage.admin_order_field = 'education_grade__education_stage' # Allows sorting by education stage

    def get_country(self, obj):
        return obj.education_grade.education_stage.country

    get_country.short_description = 'Country'
    get_country.admin_order_field = 'education_grade__education_stage__country' # Allows sorting by country


class SubjectAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'description', 'available', 'image', 'semester', 'get_education_grade', 'get_education_stage', 'get_country')
    search_fields = ('name',)
    ...
    get_education_grade.admin_order_field = 'semester__education_grade' # Allows sorting by education grade
